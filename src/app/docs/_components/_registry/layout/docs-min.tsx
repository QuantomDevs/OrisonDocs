'use client';
import type * as PageTree from '@docs/core/page-tree';
import { type ComponentProps, type ReactNode, useMemo } from 'react';
import { cn } from '../../utils/cn';
import { TreeContextProvider, useTreeContext } from '@docs/ui/contexts/tree';
import Link from '@docs/core/link';
import { useSearchContext } from '@docs/ui/contexts/search';
import { useSidebar } from '@docs/ui/contexts/sidebar';
import { cva } from 'class-variance-authority';
import { usePathname } from '@docs/core/framework';
