...
import Link, { type LinkProps } from 'quantomdocs-core/link';
import { useOnChange } from 'quantomdocs-core/utils/use-on-change';
...
import { useMediaQuery } from 'quantomdocs-core/utils/use-media-query';
