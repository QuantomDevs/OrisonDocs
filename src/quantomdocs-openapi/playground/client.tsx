...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from 'quantomdocs-ui/components/ui/collapsible';
...
import { cn } from 'quantomdocs-ui/utils/cn';
import {
  type FieldInfo,
  SchemaProvider,
  useResolvedSchema,
...
export interface PlaygroundClientOptions {
   ...
   * - the library itself, with types from `quantomdocs-openapi/playground/client`.
   * - the `Custom.useController()` from `quantomdocs-openapi/playground/client`.
   *
