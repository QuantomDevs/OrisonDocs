---
title: docs OpenAPI v10
description: Introducing docs OpenAPI v10.
author:  Nama
date: 2025-11-06
---

We are pleased to announce the release of docs OpenAPI v10.
...
3. **Client Configuration Support:**
   ...
   'use client';
   import { defineClientConfig } from 'quantomdocs-openapi/ui/client';
...
docs OpenAPI now prefers per-feature customizations, eliminating the centralized `renderer` API. Custom render functions are now specified directly in the `content` option when creating an API page.
...
```ts tab="After"
import { generateFiles } from 'quantomdocs-openapi';
import { openapi } from '@/lib/openapi';
...
export default defineClientConfig({
  storageKeyPrefix: 'quantomdocs-openapi-custom-',
});
```
