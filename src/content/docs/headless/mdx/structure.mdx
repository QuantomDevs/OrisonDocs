...
import { remarkStructure } from 'quantomdocs-core/mdx-plugins';
...
> This plugin is included by default on docs MDX.
...
```ts
import { structure } from 'quantomdocs-core/mdx-plugins';
