...
description: Integrate Algolia Search with docs
---
...
import type { DocumentRecord } from 'quantomdocs-core/search/algolia';
...
import { sync, DocumentRecord } from 'quantomdocs-core/search/algolia';
...
- Using [docs UI search dialog](/docs/ui/search/algolia).
...
- **docs UI**: Enable [Tag Filter](/docs/ui/search/algolia#tag-filter) on Search UI.
