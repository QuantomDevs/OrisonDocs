...
3. Create a script to sync search indexes.
   ...
   import { sync, type OramaDocument } from 'quantomdocs-core/search/orama-cloud';
...
- Using [docs UI search dialog](/docs/ui/search/orama-cloud).
- Custom search UI using the built-in hook of docs:
