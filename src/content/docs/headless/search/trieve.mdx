---
title: Trieve Search
description: Integrate Trieve Search with docs
---
...
```package-install
trieve-ts-sdk trieve-docs-adapter
```
...
import { type TrieveDocument } from 'trieve-docs-adapter/search/sync';
...
import { sync, type TrieveDocument } from 'trieve-docs-adapter/search/sync';
...
'use client';
import type { SharedProps } from 'quantomdocs-ui/components/dialog/search';
import SearchDialog from 'trieve-docs-adapter/components/dialog/search';
import { TrieveSDK } from 'trieve-ts-sdk';
...
```ts
import { TrieveSDK } from 'trieve-ts-sdk';
import { useTrieveSearch } from 'trieve-docs-adapter/search/trieve';
...
```js
import { sync } from 'trieve-docs-adapter/search/sync';
import { TrieveSDK } from 'trieve-ts-sdk';
