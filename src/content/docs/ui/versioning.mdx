...
docs provide the primitives for you to implement versioning on your own way.
...
Sometimes you want to version the entire website, such as https://v14.docs.dev (docs v14) and https://docs.dev (Latest docs).
