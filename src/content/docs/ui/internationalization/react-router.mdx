---
title: React Router
description: Support i18n routing on your React Router + docs app.
---
...
import { defineI18n } from 'quantomdocs-core/i18n';
...
import { defineI18nUI } from 'quantomdocs-ui/i18n';
...
import { i18n } from '@/lib/i18n';
import type { BaseLayoutProps } from 'quantomdocs-ui/layouts/shared';
...
Pass the locale to docs in your pages and layouts.
...
docs only handles navigation for its own layouts (e.g. sidebar).
...
In addition, the [`quantomdocs-core/dynamic-link`](/docs/headless/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to attend the locale prefix.
It is useful for Markdown/MDX content.

```mdx title="content.mdx"
import { DynamicLink } from 'quantomdocs-core/dynamic-link';
