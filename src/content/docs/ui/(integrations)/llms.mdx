---
title: AI & LLMs
description: Integrate AI functionality to docs.
---
...
In **docs MDX**, you can do:

```ts title="lib/get-llm-text.ts"
import { source } from '@/lib/source';
import type { InferPageType } from 'quantomdocs-core/source';
...
import { rewritePath } from 'quantomdocs-core/negotiation';
...
```npm
npx @docs/cli add ai/page-actions
```
...
You can install the AI search dialog using docs CLI:

```npm
npx @docs/cli add ai/search
```
...
Note that docs doesn't provide the AI model, it's up to you.
