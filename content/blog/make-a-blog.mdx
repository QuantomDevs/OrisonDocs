---
title: Making a Blog with docs
description: docs + Blog
author:  Nama
date: 2024-12-15
---

docs is a docs framework, but it's also a powerful tool to manage content in Next.js. You can use docs to build a blog site along with docs, on a single Next.js app.

## Overview

This guide helps you build a blog site with docs and docs MDX.

We will use docs MDX to manage the content, and implement our own UI with Tailwind CSS & docs UI.
...
import { defineCollections, frontmatterSchema } from 'quantomdocs-mdx/config';
import { z } from 'zod';
...
Colors like `text-fd-muted-foreground` are from the design system of docs UI, you may also use your own colors, or use Shadcn UI.
