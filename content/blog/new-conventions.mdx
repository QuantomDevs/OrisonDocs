...
I love to have fewer files, but considering `create-docs-app` should also act as a starting point for beginners who may not be familiar with MDX, it's much more helpful to provide it by default.
...
The new [Internationalization](/docs/ui/internationalization) guide requires docs 15.2.3 or above.
