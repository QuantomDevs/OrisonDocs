---
title: Next.js
description: Support i18n routing on your Next.js + docs app
---
...
import { RootProvider } from 'quantomdocs-ui/provider/next';
...
In addition, the [`quantomdocs-core/dynamic-link`](/docs/headless/components/link#dynamic-hrefs) component supports dynamic hrefs, you can use it to prepend the locale prefix.
