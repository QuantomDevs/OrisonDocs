...
import {
  ...
  DocsTitle,
  DocsBody,
} from 'quantomdocs-ui/layouts/notebook/page';
...
```tsx
import { DocsPage } from 'quantomdocs-ui/layouts/docs/page';

<DocsPage>
  <a
    href={`https://github.com/-nama/docs/blob/main/content/docs/${page.path}`}
...
```tsx
import { DocsPage, PageLastUpdate } from 'quantomdocs-ui/layouts/docs/page';
...
<Tabs items={['docs MDX', 'GitHub API']}>
...
```tsx
import { getGithubLastEdit } from 'quantomdocs-core/content/github';
...
[TOC Utility](/docs/headless/utils/get-toc). Content sources like docs MDX offer this out-of-the-box.
