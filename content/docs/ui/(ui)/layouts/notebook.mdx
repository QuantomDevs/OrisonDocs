...
Enable the notebook layout with `quantomdocs-ui/layouts/notebook`, it's a more compact layout than the default one.

```tsx title="layout.tsx"
import { DocsLayout } from 'quantomdocs-ui/layouts/notebook'; // [!code highlight]
