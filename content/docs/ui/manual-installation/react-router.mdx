---
title: React Router
description: Setup docs on React Router.
---
...
- Tailwind CSS 4.
- docs MDX: follow the [Vite setup guide](/docs/mdx/vite) and create essential files like `lib/source.ts`.

### Installation

```npm
npm i quantomdocs-core quantomdocs-ui
```
...
Wrap your entire app under docs providers:
