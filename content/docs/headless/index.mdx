...
docs Core offers server-side functions and headless components to build docs on any React.js frameworks like Next.js.
...
<Callout title="Tip">
    ...
    It can be used without docs UI, in other words, it's headless.

    For beginners and normal usages, use [docs UI](/docs/ui).
...
export function RootLayout({ children }: { children: ReactNode }) {
  // or if you're using docs UI, use `<RootProvider />`
