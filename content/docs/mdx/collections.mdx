...
By design, this will remove all default settings applied by your global config and docs MDX.
...
```ts
import { frontmatterSchema, metaSchema, defineDocs } from 'quantomdocs-mdx/config';
import { z } from 'zod';
